...
import com.example.soup.domain.admin.ThemeCategoryRepository;
import com.example.soup.domain.admin.ThemeRepository;
import com.example.soup.domain.common.exceptions.ElasticSearchException;
...
public class SearchService {
    ...
    public List<Product> findAll(Pageable pageable) {
        return searchRepository.findAll(pageable).toList();
    }
}
